...
const ProductBasedPayrollBreakdown = ({ employeePayrollId, payrollMonth }) => {
  ...
  if (!breakdown || breakdown.salaryType !== 'ProductBased') {
    return <Alert variant="warning">No ProductBased payroll data available</Alert>;
  }
    ...
    <div className="payroll-breakdown-container">
      ...
      <Card className="mb-4 shadow-sm">
        <Card.Header className="bg-primary text-white">
          <h5 className="mb-0">📊 Chi tiết lương (Theo Sản Phẩm)</h5>
        </Card.Header>
        <Card.Body>
          <Row>
            <Col md={4}>
            ...
            <Col md={4}>
              <p><strong>Loại lương:</strong> <span className="badge bg-warning">ProductBased</span></p>
      ...
      <Card className="mb-4 shadow-sm">
        <Card.Header className="bg-light">
          <h6 className="mb-0">🏭 Lương Sản Phẩm</h6>
        </Card.Header>
        <Card.Body>
          <Table size="sm" bordered>
            <tbody>
              ...
              <tr>
                ...
                <td className="text-right">{breakdown.productCount} sản phẩm</td>
              </tr>
              <tr>
                <td><strong>Giá công đơn vị</strong></td>
                <td className="text-right">{formatCurrency(breakdown.unitPrice)}</td>
              </tr>
              <tr className="table-success">
                <td><strong>Lương sản phẩm</strong> (sản phẩm × giá công)</td>
                <td className="text-right"><strong>{formatCurrency(breakdown.productBonus)}</strong></td>
              </tr>
            </tbody>
          </Table>
        </Card.Body>
...
export default ProductBasedPayrollBreakdown;